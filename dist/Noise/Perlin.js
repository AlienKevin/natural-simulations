...
var $author$project$Noise$Perlin$view = function (model) {
	return A2(
		...
		A2($elm$core$List$map, $author$project$Noise$Perlin$bar, model.T));
};
var $author$project$Noise$Perlin$main = $elm$browser$Browser$element(
	{b1: $author$project$Noise$Perlin$init, cq: $author$project$Noise$Perlin$subscriptions, cw: $author$project$Noise$Perlin$update, cx: $author$project$Noise$Perlin$view});
