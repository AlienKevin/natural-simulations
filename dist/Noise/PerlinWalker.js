...
var $author$project$Noise$PerlinWalker$view = function (model) {
	return A2(
		...
		A2($elm$core$List$map, $author$project$Noise$PerlinWalker$point, model.W));
};
var $author$project$Noise$PerlinWalker$main = $elm$browser$Browser$element(
	{b1: $author$project$Noise$PerlinWalker$init, cq: $author$project$Noise$PerlinWalker$subscriptions, cw: $author$project$Noise$PerlinWalker$update, cx: $author$project$Noise$PerlinWalker$view});
_Platform_export({'Noise':{'PerlinWalker':{'init':$author$project$Noise$PerlinWalker$main(
