...
{
	if (region.aI.T === region.aS.T)
	{
		return 'on line ' + region.aI.T;
	}
	return 'on lines ' + region.aI.T + ' through ' + region.aS.T;
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {aU: fragment, aW: host, bl: path, bn: port_, bq: protocol, br: query};
	});
...
var $author$project$Noise$SimplexNoise$permutationTable = function (seed) {
	...
	return _Utils_Tuple2(
		{
			U: perm,
			V: $author$project$Noise$SimplexNoise$generatePermMod12(perm)
		},
		seed_1);
};
...
var $author$project$Noise$AnimatedBox$init = function (_v0) {
	return _Utils_Tuple2(
		{
			al: $author$project$Noise$AnimatedBox$getShades(0),
			am: 0
		},
...
var $elm$time$Time$State = F2(
	function (taggers, processes) {
		return {bp: processes, bx: taggers};
	});
...
var $author$project$Noise$AnimatedBox$update = F2(
	function (msg, model) {
		var newTime = model.am + 0.06;
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					al: $author$project$Noise$AnimatedBox$getShades(newTime),
					am: newTime
				}),
			$elm$core$Platform$Cmd$none);
	});
...
var $author$project$Noise$AnimatedBox$view = function (model) {
	return A2(
		...
		A2($elm$core$List$map, $author$project$Noise$AnimatedBox$point, model.al));
};
var $author$project$Noise$AnimatedBox$main = $elm$browser$Browser$element(
	{b1: $author$project$Noise$AnimatedBox$init, cq: $author$project$Noise$AnimatedBox$subscriptions, cw: $author$project$Noise$AnimatedBox$update, cx: $author$project$Noise$AnimatedBox$view});
_Platform_export({'Noise':{'AnimatedBox':{'init':$author$project$Noise$AnimatedBox$main(
