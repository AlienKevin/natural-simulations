...
var $author$project$Noise$RandomBox$update = F2(
	function (msg, model) {
		var row = msg;
		var newShades = _Utils_ap(model.V, row);
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{V: newShades}),
...
var $author$project$Noise$RandomBox$view = function (model) {
	return A2(
		...
		A2($elm$core$List$indexedMap, $author$project$Noise$RandomBox$point, model.V));
};
var $author$project$Noise$RandomBox$main = $elm$browser$Browser$element(
	{b$: $author$project$Noise$RandomBox$init, co: $author$project$Noise$RandomBox$subscriptions, cu: $author$project$Noise$RandomBox$update, cv: $author$project$Noise$RandomBox$view});
_Platform_export({'Noise':{'RandomBox':{'init':$author$project$Noise$RandomBox$main(
