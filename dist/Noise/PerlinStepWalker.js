...
var $author$project$Noise$SimplexNoise$permutationTable = function (seed) {
	...
	return _Utils_Tuple2(
		{
			V: perm,
			W: $author$project$Noise$SimplexNoise$generatePermMod12(perm)
		},
		seed_1);
};
...
var $author$project$Noise$PerlinStepWalker$view = function (model) {
	return A2(
		...
		A2($elm$core$List$map, $author$project$Noise$PerlinStepWalker$point, model.M));
};
var $author$project$Noise$PerlinStepWalker$main = $elm$browser$Browser$element(
	{b1: $author$project$Noise$PerlinStepWalker$init, cq: $author$project$Noise$PerlinStepWalker$subscriptions, cw: $author$project$Noise$PerlinStepWalker$update, cx: $author$project$Noise$PerlinStepWalker$view});
_Platform_export({'Noise':{'PerlinStepWalker':{'init':$author$project$Noise$PerlinStepWalker$main(
