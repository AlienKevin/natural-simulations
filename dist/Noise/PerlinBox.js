...
var $author$project$Noise$PerlinBox$init = function (_v0) {
	return _Utils_Tuple2(
		{aF: $author$project$Noise$PerlinBox$initShades},
...
var $author$project$Noise$PerlinBox$view = function (model) {
	return A2(
		...
		A2($elm$core$List$map, $author$project$Noise$PerlinBox$point, model.aF));
};
var $author$project$Noise$PerlinBox$main = $elm$browser$Browser$element(
	{b1: $author$project$Noise$PerlinBox$init, cq: $author$project$Noise$PerlinBox$subscriptions, cw: $author$project$Noise$PerlinBox$update, cx: $author$project$Noise$PerlinBox$view});
_Platform_export({'Noise':{'PerlinBox':{'init':$author$project$Noise$PerlinBox$main(
