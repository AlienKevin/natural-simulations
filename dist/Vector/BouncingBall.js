...
var $author$project$Vector$BouncingBall$init = function (_v0) {
	return _Utils_Tuple2(
		{ab: 20, U: $author$project$Vector$BouncingBall$defaultPosition, ao: 3, ap: -1},
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2($author$project$Vector$BouncingBall$point, model.ab, model.U)
			]));
};
var $author$project$Vector$BouncingBall$main = $elm$browser$Browser$element(
	{b2: $author$project$Vector$BouncingBall$init, cr: $author$project$Vector$BouncingBall$subscriptions, cx: $author$project$Vector$BouncingBall$update, cy: $author$project$Vector$BouncingBall$view});
_Platform_export({'Vector':{'BouncingBall':{'init':$author$project$Vector$BouncingBall$main(
