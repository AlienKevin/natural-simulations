...
{
	if (region.aJ.T === region.aT.T)
	{
		return 'on line ' + region.aJ.T;
	}
	return 'on lines ' + region.aJ.T + ' through ' + region.aT.T;
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {aV: fragment, aX: host, bm: path, bo: port_, br: protocol, bs: query};
	});
...
var $elm$time$Time$State = F2(
	function (taggers, processes) {
		return {bq: processes, by: taggers};
	});
...
var $author$project$Oscillations$SimpleHarmonicMotion$update = F2(
	function (msg, model) {
		var newPosition = model.ao * $elm$core$Basics$sin(((2 * $elm$core$Basics$pi) * model.Z) / model.aD);
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{U: newPosition, Z: model.Z + 1}),
			$elm$core$Platform$Cmd$none);
	});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Oscillations$SimpleHarmonicMotion$viewString(model.U),
				A2($author$project$Oscillations$SimpleHarmonicMotion$viewBall, model.ar, model.U)
			]));
};
var $author$project$Oscillations$SimpleHarmonicMotion$main = $elm$browser$Browser$element(
	{b2: $author$project$Oscillations$SimpleHarmonicMotion$init, cr: $author$project$Oscillations$SimpleHarmonicMotion$subscriptions, cx: $author$project$Oscillations$SimpleHarmonicMotion$update, cy: $author$project$Oscillations$SimpleHarmonicMotion$view});
_Platform_export({'Oscillations':{'SimpleHarmonicMotion':{'init':$author$project$Oscillations$SimpleHarmonicMotion$main(
