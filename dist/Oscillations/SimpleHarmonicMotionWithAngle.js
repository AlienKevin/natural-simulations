...
{
	if (region.aK.U === region.aU.U)
	{
		return 'on line ' + region.aK.U;
	}
	return 'on lines ' + region.aK.U + ' through ' + region.aU.U;
}
...
var $author$project$Oscillations$SimpleHarmonicMotionWithAngle$init = function (_v0) {
	return _Utils_Tuple2(
		{ap: 200, S: 0, as: 20, aE: (2 * $elm$core$Basics$pi) / 300, V: 0},
...
var $author$project$Oscillations$SimpleHarmonicMotionWithAngle$update = F2(
	function (msg, model) {
		var newPosition = model.ap * $elm$core$Basics$sin(model.S);
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{S: model.S + model.aE, V: newPosition}),
			$elm$core$Platform$Cmd$none);
	});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Oscillations$SimpleHarmonicMotionWithAngle$viewString(model.V),
				A2($author$project$Oscillations$SimpleHarmonicMotionWithAngle$viewBall, model.as, model.V)
			]));
};
var $author$project$Oscillations$SimpleHarmonicMotionWithAngle$main = $elm$browser$Browser$element(
	{b3: $author$project$Oscillations$SimpleHarmonicMotionWithAngle$init, cs: $author$project$Oscillations$SimpleHarmonicMotionWithAngle$subscriptions, cy: $author$project$Oscillations$SimpleHarmonicMotionWithAngle$update, cz: $author$project$Oscillations$SimpleHarmonicMotionWithAngle$view});
_Platform_export({'Oscillations':{'SimpleHarmonicMotionWithAngle':{'init':$author$project$Oscillations$SimpleHarmonicMotionWithAngle$main(
