...
var $author$project$Oscillations$RainbowSlinky$update = F2(
	function (msg, model) {
		var newPosition = A5(
			...
			model.aB,
			model.ao,
			$elm$core$Basics$sin(((2 * $elm$core$Basics$pi) * model.Y) / model.aD));
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{ai: newPosition, Y: model.Y + 1}),
			$elm$core$Platform$Cmd$none);
	});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Oscillations$RainbowSlinky$viewSlinky(model.ai)
			]));
};
var $author$project$Oscillations$RainbowSlinky$main = $elm$browser$Browser$element(
	{b2: $author$project$Oscillations$RainbowSlinky$init, cr: $author$project$Oscillations$RainbowSlinky$subscriptions, cx: $author$project$Oscillations$RainbowSlinky$update, cy: $author$project$Oscillations$RainbowSlinky$view});
_Platform_export({'Oscillations':{'RainbowSlinky':{'init':$author$project$Oscillations$RainbowSlinky$main(
