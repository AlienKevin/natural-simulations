...
var $author$project$RandomWalks$Basic$view = function (model) {
	return A2(
		...
		A2($elm$core$List$map, $author$project$RandomWalks$Basic$point, model.M));
};
var $author$project$RandomWalks$Basic$main = $elm$browser$Browser$element(
	{b$: $author$project$RandomWalks$Basic$init, co: $author$project$RandomWalks$Basic$subscriptions, cu: $author$project$RandomWalks$Basic$update, cv: $author$project$RandomWalks$Basic$view});
_Platform_export({'RandomWalks':{'Basic':{'init':$author$project$RandomWalks$Basic$main(
