...
var $author$project$RandomWalks$MonteCarlo$view = function (model) {
	return A2(
		...
		A2($elm$core$List$map, $author$project$RandomWalks$MonteCarlo$point, model.U));
};
var $author$project$RandomWalks$MonteCarlo$main = $elm$browser$Browser$element(
	{b$: $author$project$RandomWalks$MonteCarlo$init, co: $author$project$RandomWalks$MonteCarlo$subscriptions, cu: $author$project$RandomWalks$MonteCarlo$update, cv: $author$project$RandomWalks$MonteCarlo$view});
_Platform_export({'RandomWalks':{'MonteCarlo':{'init':$author$project$RandomWalks$MonteCarlo$main(
