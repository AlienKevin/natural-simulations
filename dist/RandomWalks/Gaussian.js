...
var $author$project$RandomWalks$Gaussian$view = function (model) {
	return A2(
		...
		A2($elm$core$List$map, $author$project$RandomWalks$Gaussian$point, model.M));
};
var $author$project$RandomWalks$Gaussian$main = $elm$browser$Browser$element(
	{b$: $author$project$RandomWalks$Gaussian$init, co: $author$project$RandomWalks$Gaussian$subscriptions, cu: $author$project$RandomWalks$Gaussian$update, cv: $author$project$RandomWalks$Gaussian$view});
_Platform_export({'RandomWalks':{'Gaussian':{'init':$author$project$RandomWalks$Gaussian$main(
