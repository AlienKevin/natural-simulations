		...
		if (!msg.$) {
			...
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						U: A2($elm$core$List$cons, newPosition, model.U)
					}),
...
var $author$project$RandomWalks$NormalDistribution$view = function (model) {
	return A2(
		...
		A2($elm$core$List$map, $author$project$RandomWalks$NormalDistribution$slab, model.U));
};
var $author$project$RandomWalks$NormalDistribution$main = $elm$browser$Browser$element(
	{b$: $author$project$RandomWalks$NormalDistribution$init, co: $author$project$RandomWalks$NormalDistribution$subscriptions, cu: $author$project$RandomWalks$NormalDistribution$update, cv: $author$project$RandomWalks$NormalDistribution$view});
_Platform_export({'RandomWalks':{'NormalDistribution':{'init':$author$project$RandomWalks$NormalDistribution$main(
