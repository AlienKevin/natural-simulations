...
var $author$project$RandomWalks$Levy$view = function (model) {
	return A2(
		...
		A2($elm$core$List$map, $author$project$RandomWalks$Levy$point, model.M));
};
var $author$project$RandomWalks$Levy$main = $elm$browser$Browser$element(
	{b$: $author$project$RandomWalks$Levy$init, co: $author$project$RandomWalks$Levy$subscriptions, cu: $author$project$RandomWalks$Levy$update, cv: $author$project$RandomWalks$Levy$view});
_Platform_export({'RandomWalks':{'Levy':{'init':$author$project$RandomWalks$Levy$main(
