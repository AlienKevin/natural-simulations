...
var $author$project$RandomWalks$Improved$view = function (model) {
	return A2(
		...
		A2($elm$core$List$map, $author$project$RandomWalks$Improved$point, model.M));
};
var $author$project$RandomWalks$Improved$main = $elm$browser$Browser$element(
	{b$: $author$project$RandomWalks$Improved$init, co: $author$project$RandomWalks$Improved$subscriptions, cu: $author$project$RandomWalks$Improved$update, cv: $author$project$RandomWalks$Improved$view});
_Platform_export({'RandomWalks':{'Improved':{'init':$author$project$RandomWalks$Improved$main(
