...
var $author$project$RandomWalks$PaintSplatter$view = function (model) {
	return A2(
		...
		A2($elm$core$List$map, $author$project$RandomWalks$PaintSplatter$point, model.U));
};
var $author$project$RandomWalks$PaintSplatter$main = $elm$browser$Browser$element(
	{b$: $author$project$RandomWalks$PaintSplatter$init, co: $author$project$RandomWalks$PaintSplatter$subscriptions, cu: $author$project$RandomWalks$PaintSplatter$update, cv: $author$project$RandomWalks$PaintSplatter$view});
_Platform_export({'RandomWalks':{'PaintSplatter':{'init':$author$project$RandomWalks$PaintSplatter$main(
