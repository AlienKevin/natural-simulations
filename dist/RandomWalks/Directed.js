...
var $author$project$RandomWalks$Directed$view = function (model) {
	return A2(
		...
		A2($elm$core$List$map, $author$project$RandomWalks$Directed$point, model.M));
};
var $author$project$RandomWalks$Directed$main = $elm$browser$Browser$element(
	{b$: $author$project$RandomWalks$Directed$init, co: $author$project$RandomWalks$Directed$subscriptions, cu: $author$project$RandomWalks$Directed$update, cv: $author$project$RandomWalks$Directed$view});
_Platform_export({'RandomWalks':{'Directed':{'init':$author$project$RandomWalks$Directed$main(
