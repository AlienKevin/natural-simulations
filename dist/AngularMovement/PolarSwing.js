...
{
	if (region.aH.U === region.aR.U)
	{
		return 'on line ' + region.aH.U;
	}
	return 'on lines ' + region.aH.U + ' through ' + region.aR.U;
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {aT: fragment, aV: host, bk: path, bm: port_, bp: protocol, bq: query};
	});
...
var $author$project$AngularMovement$PolarSwing$init = function (_v0) {
	return _Utils_Tuple2(
		{aq: 20, M: $author$project$AngularMovement$PolarSwing$defaultPosition, bw: 100},
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$AngularMovement$PolarSwing$viewString(model.M),
				A2($author$project$AngularMovement$PolarSwing$viewBall, model.aq, model.M)
			]));
};
var $author$project$AngularMovement$PolarSwing$main = $elm$browser$Browser$element(
	{b1: $author$project$AngularMovement$PolarSwing$init, cq: $author$project$AngularMovement$PolarSwing$subscriptions, cw: $author$project$AngularMovement$PolarSwing$update, cx: $author$project$AngularMovement$PolarSwing$view});
_Platform_export({'AngularMovement':{'PolarSwing':{'init':$author$project$AngularMovement$PolarSwing$main(
