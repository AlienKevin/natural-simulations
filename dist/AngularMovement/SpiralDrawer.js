...
{
	if (region.aI.U === region.aS.U)
	{
		return 'on line ' + region.aI.U;
	}
	return 'on lines ' + region.aI.U + ' through ' + region.aS.U;
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {aU: fragment, aW: host, V: path, bm: port_, bp: protocol, bq: query};
	});
...
var $author$project$AngularMovement$SpiralDrawer$init = function (_v0) {
	return _Utils_Tuple2(
		{ar: 20, V: _List_Nil, M: $author$project$AngularMovement$SpiralDrawer$defaultPosition, bw: 100},
...
var $elm$time$Time$State = F2(
	function (taggers, processes) {
		return {bo: processes, bx: taggers};
	});
	...
	function (msg, model) {
		...
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					V: A2($elm$core$List$cons, newPosition, model.V),
					M: newPosition
				}),
			$elm$core$Platform$Cmd$none);
	});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$AngularMovement$SpiralDrawer$viewPath(model.V),
				$author$project$AngularMovement$SpiralDrawer$viewString(model.M),
				A2($author$project$AngularMovement$SpiralDrawer$viewBall, model.ar, model.M)
			]));
};
var $author$project$AngularMovement$SpiralDrawer$main = $elm$browser$Browser$element(
	{b1: $author$project$AngularMovement$SpiralDrawer$init, cq: $author$project$AngularMovement$SpiralDrawer$subscriptions, cw: $author$project$AngularMovement$SpiralDrawer$update, cx: $author$project$AngularMovement$SpiralDrawer$view});
_Platform_export({'AngularMovement':{'SpiralDrawer':{'init':$author$project$AngularMovement$SpiralDrawer$main(
