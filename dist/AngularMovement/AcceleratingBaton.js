...
{
	if (region.aH.T === region.aR.T)
	{
		return 'on line ' + region.aH.T;
	}
	return 'on lines ' + region.aH.T + ' through ' + region.aR.T;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { bY: 'hidden', bI: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { bY: 'mozHidden', bI: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { bY: 'msHidden', bI: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { bY: 'webkitHidden', bI: 'webkitvisibilitychange' }
		: { bY: 'hidden', bI: 'visibilitychange' };
}
...
var $elm$time$Time$State = F2(
	function (taggers, processes) {
		return {bo: processes, bw: taggers};
	});
...
var $elm$time$Time$onSelfMsg = F3(
	function (router, interval, state) {
		var _v0 = A2($elm$core$Dict$get, interval, state.bw);
		if (_v0.$ === 1) {
...
var $author$project$AngularMovement$AcceleratingBaton$update = F2(
	function (msg, model) {
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{R: model.R + model.U, U: model.U + model.ao}),
			$elm$core$Platform$Cmd$none);
	});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$AngularMovement$AcceleratingBaton$viewBaton(model.R)
			]));
};
var $author$project$AngularMovement$AcceleratingBaton$main = $elm$browser$Browser$element(
	{b0: $author$project$AngularMovement$AcceleratingBaton$init, cp: $author$project$AngularMovement$AcceleratingBaton$subscriptions, cv: $author$project$AngularMovement$AcceleratingBaton$update, cw: $author$project$AngularMovement$AcceleratingBaton$view});
_Platform_export({'AngularMovement':{'AcceleratingBaton':{'init':$author$project$AngularMovement$AcceleratingBaton$main(
