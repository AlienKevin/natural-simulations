...
{
	if (region.aG.Q === region.aQ.Q)
	{
		return 'on line ' + region.aG.Q;
	}
	return 'on lines ' + region.aG.Q + ' through ' + region.aQ.Q;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { b$: 'hidden', bL: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { b$: 'mozHidden', bL: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { b$: 'msHidden', bL: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { b$: 'webkitHidden', bL: 'webkitvisibilitychange' }
		: { b$: 'hidden', bL: 'visibilitychange' };
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {aS: fragment, aU: host, bk: path, bm: port_, bp: protocol, bq: query};
	});
...
var $evancz$elm_playground$Playground$MouseClick = {$: 6};
...
var $elm$browser$Browser$AnimationManager$State = F3(
	function (subs, request, oldTime) {
		return {ay: oldTime, bs: request, bv: subs};
	});
...
var $evancz$elm_playground$Playground$Mouse = F4(
	function (x, y, down, click) {
		return {ap: click, bW: down, bD: x, bE: y};
	});
var $evancz$elm_playground$Playground$Time = $elm$core$Basics$identity;
var $elm$core$Set$Set_elm_builtin = $elm$core$Basics$identity;
var $elm$core$Set$empty = $elm$core$Dict$empty;
var $evancz$elm_playground$Playground$emptyKeyboard = {al: false, bW: false, as: false, b4: $elm$core$Set$empty, aw: false, aB: false, aD: false, aE: false, ai: false};
...
var $evancz$elm_playground$Playground$toScreen = F2(
	function (width, height) {
		return {aL: (-height) / 2, aT: height, aw: (-width) / 2, aB: width / 2, bx: height / 2, bC: width};
	});
...
var $evancz$elm_playground$Playground$updateKeyboard = F3(
	function (isDown, key, keyboard) {
		var keys = isDown ? A2($elm$core$Set$insert, key, keyboard.b4) : A2($elm$core$Set$remove, key, keyboard.b4);
		switch (key) {
			case ' ':
				return _Utils_update(
					keyboard,
		...
		switch (msg.$) {
			case 1:
				...
				return A3(
					...
					computer.g.ap ? _Utils_update(
						computer,
						{
							g: A2($evancz$elm_playground$Playground$mouseClick, false, computer.g),
							ah: time
						}) : _Utils_update(
						computer,
						{ah: time}));
			case 2:
				var viewport = msg.a.bA;
				return A3(
					$evancz$elm_playground$Playground$Game,
					vis,
					memory,
					_Utils_update(
						computer,
						{
							y: A2($evancz$elm_playground$Playground$toScreen, viewport.bC, viewport.aT)
						}));
			case 3:
				var w = msg.a;
				var h = msg.b;
				return A3(
					...
					_Utils_update(
						computer,
						{
							y: A2($evancz$elm_playground$Playground$toScreen, w, h)
						}));
			case 0:
				var isDown = msg.a;
				var key = msg.b;
			...
			case 5:
				var pageX = msg.a;
				var pageY = msg.b;
				var y = computer.y.bx - pageY;
				var x = computer.y.aw + pageX;
				return A3(
					$evancz$elm_playground$Playground$Game,
					vis,
					memory,
					_Utils_update(
						computer,
						{
							g: A3($evancz$elm_playground$Playground$mouseMove, x, y, computer.g)
						}));
			case 6:
				return A3(
					$evancz$elm_playground$Playground$Game,
					...
					_Utils_update(
						computer,
						{
							g: A2($evancz$elm_playground$Playground$mouseClick, true, computer.g)
						}));
			case 7:
				var isDown = msg.a;
				return A3(
					...
					_Utils_update(
						computer,
						{
							g: A2($evancz$elm_playground$Playground$mouseDown, isDown, computer.g)
						}));
			default:
				...
				return A3(
					...
					_Utils_update(
						computer,
						{
							...
							g: A4($evancz$elm_playground$Playground$Mouse, computer.g.bD, computer.g.bE, false, false)
						}));
		}
	});
...
var $evancz$elm_playground$Playground$initialComputer = {
	av: $evancz$elm_playground$Playground$emptyKeyboard,
	g: A4($evancz$elm_playground$Playground$Mouse, 0, 0, false, false),
	y: A2($evancz$elm_playground$Playground$toScreen, 600, 600),
...
var $evancz$elm_playground$Playground$render = F2(
	function (screen, shapes) {
		var y = $elm$core$String$fromFloat(screen.aL);
		var x = $elm$core$String$fromFloat(screen.aw);
		var w = $elm$core$String$fromFloat(screen.bC);
		var h = $elm$core$String$fromFloat(screen.aT);
		return A2(
			$elm$svg$Svg$svg,
			_List_fromArray(
				[
...
var $evancz$elm_playground$Playground$game = F3(
	function (viewMemory, updateMemory, initialMemory) {
		...
		var init = function (_v0) {
			return _Utils_Tuple2(
				A3($evancz$elm_playground$Playground$Game, 0, initialMemory, $evancz$elm_playground$Playground$initialComputer),
		...
		return $elm$browser$Browser$document(
			{aW: init, cs: subscriptions, by: update, bz: view});
	});
...
var $author$project$AngularMovement$Asteroids$update = F2(
	function (computer, model) {
		var theta = $elm$core$Basics$degrees(model.A + 90);
		var speed = A2($elm$core$Set$member, 'z', computer.av.b4) ? (model.aF * 1.5) : model.aF;
		var r = 30;
		var dy = speed * $elm$core$Basics$sin(theta);
		var dx = speed * $elm$core$Basics$cos(theta);
		var _v0 = model.ae;
		var x = _v0.a;
		var y = _v0.b;
		var newX = (_Utils_cmp(x, computer.y.aw - r) < 0) ? (computer.y.aB + r) : ((_Utils_cmp(x, computer.y.aB + r) > 0) ? (computer.y.aw - r) : (x + dx));
		var newY = (_Utils_cmp(y, computer.y.aL - r) < 0) ? (computer.y.bx + r) : ((_Utils_cmp(y, computer.y.bx + r) > 0) ? (computer.y.aL - r) : (y + dy));
		return _Utils_update(
			model,
			{
				A: computer.av.aw ? (model.A + 2) : (computer.av.aB ? (model.A - 2) : model.A),
				ae: _Utils_Tuple2(newX, newY)
			});
	});
var $evancz$elm_playground$Playground$Hex = function (a) {
	return {$: 0, a: a};
};
var $evancz$elm_playground$Playground$darkGrey = $evancz$elm_playground$Playground$Hex('#babdb6');
...
var $evancz$elm_playground$Playground$moveLeft = F2(
	function (dx, _v0) {
		var x = _v0.a;
		var y = _v0.b;
		var a = _v0.c;
...
var $author$project$AngularMovement$Asteroids$view = F2(
					...
					$evancz$elm_playground$Playground$group(
						_List_fromArray(
							[
								...
								$evancz$elm_playground$Playground$darkGrey,
								_List_fromArray(
									[
										_Utils_Tuple2(-20, -30),
										_Utils_Tuple2(20, -30),
								...
								A2(
								$evancz$elm_playground$Playground$moveLeft,
								10,
								A2(
									$evancz$elm_playground$Playground$moveDown,
									30,
									A3($evancz$elm_playground$Playground$rectangle, $evancz$elm_playground$Playground$darkGrey, 10, 10))),
								A2(
...
var $author$project$AngularMovement$Asteroids$main = A3(
	$evancz$elm_playground$Playground$game,
	$author$project$AngularMovement$Asteroids$view,
	$author$project$AngularMovement$Asteroids$update,
	{
		A: 0,
		ae: _Utils_Tuple2(0, 0),
		aF: 5
	});
_Platform_export({'AngularMovement':{'Asteroids':{'init':$author$project$AngularMovement$Asteroids$main(
