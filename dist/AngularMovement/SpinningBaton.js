	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$AngularMovement$SpinningBaton$viewBaton(model.S)
			]));
};
var $author$project$AngularMovement$SpinningBaton$main = $elm$browser$Browser$element(
	{b$: $author$project$AngularMovement$SpinningBaton$init, co: $author$project$AngularMovement$SpinningBaton$subscriptions, cu: $author$project$AngularMovement$SpinningBaton$update, cv: $author$project$AngularMovement$SpinningBaton$view});
_Platform_export({'AngularMovement':{'SpinningBaton':{'init':$author$project$AngularMovement$SpinningBaton$main(
